...
- **Domain:** USDT0 Bridge (EVM).
- **Key Technology:** LayerZero V2.
- **Features:** Cross-chain USDT0 transfers (OFT standard).
- **Compatibility:** Works with `wdk-wallet-evm` and `wdk-wallet-evm-erc-4337`.
